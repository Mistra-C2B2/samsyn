...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "legend_config", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "layer_metadata", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "map_metadata", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(
...
def downgrade() -> None:
    ...
    # Note: Geometry spatial index is dropped automatically with table
