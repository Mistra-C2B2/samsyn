            ...
            {layers.length === 0 ? (
              ...
              layers.map((layer, index) => (
                <div
                  ...
                  className={`rounded-lg p-3 space-y-3 cursor-move hover:border-slate-300 transition-colors ${
                    ...
                    highlightedLayerId === layer.id
                      ? "bg-teal-100 border border-teal-400 ring-2 ring-teal-300 shadow-md"
                      : "bg-slate-50 border border-slate-200"
                  }`}
                  style={
                    highlightedLayerId === layer.id
                      ? { borderLeftWidth: "6px", borderLeftColor: "#14b8a6" }
                      : undefined
                  }
                >
