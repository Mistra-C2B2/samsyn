...
import { Download, Trash2, Shield, Info, Settings2, Globe, Type, Moon } from 'lucide-react';
...
function SettingsDialogContent({ open, onOpenChange }: { open: boolean; onOpenChange: (open: boolean) => void }) {
  const { user } = useUser();
  ...
  const handleDeleteData = () => {
    ...
    toast.success('Your data deletion request has been submitted. You will be signed out.');
            ...
            <TabsContent value="preferences" className="space-y-4 mt-4">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={textSize} onValueChange={(value) => {
                    setTextSize(value);
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-slate-500">
                    ...
                    <a href="mailto:support@samsyn.app" className="text-teal-600 hover:text-teal-700">
                      support@samsyn.app
                    </a>
                  </p>
                </div>
...
export function SettingsDialog({ open, onOpenChange, isClerkConfigured = false }: SettingsDialogProps) {
        ...
        <Tabs defaultValue="account" className="w-full">
          ...
          <TabsContent value="account" className="space-y-4 mt-4">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-slate-500">Please sign in to view account settings</p>
            </div>
